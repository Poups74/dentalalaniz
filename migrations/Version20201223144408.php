 ...
 */
final class Version20201223144408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_BE402FAC3DA5256D ON membre_equipe');
        $this->addSql('ALTER TABLE membre_equipe ADD image VARCHAR(255) DEFAULT NULL, DROP image_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE membre_equipe ADD image_id INT DEFAULT NULL, DROP image');
        $this->addSql('ALTER TABLE membre_equipe ADD CONSTRAINT FK_BE402FAC3DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BE402FAC3DA5256D ON membre_equipe (image_id)');
    }
}
